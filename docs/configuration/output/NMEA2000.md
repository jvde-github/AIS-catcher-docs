...
In v0.56 we introduced "Experimenter Mode" for NMEA2000 input and output via socketCAN on Linux. To properly handle the mechanics of a NMEA2000 network, the [NMEA2000 library](https://github.com/ttlappalainen/NMEA2000) library by  Timo Lappalainen
...
## Summary Settings — Input (`-i`)

| Setting (JSON key / CLI setting name) | Type | Default | Description |
|---------|------|---------|-------------|
| <span class="cmd-setting">interface</span> | string | <span class="cmd-value">-</span> | socketCAN interface name (e.g. `vcan0`, `can0`) |

## Summary Settings — Output (`-I`)

| Setting (JSON key / CLI setting name) | Type | Default | Description |
|---------|------|---------|-------------|
| <span class="cmd-setting">device</span> | string | <span class="cmd-value">-</span> | socketCAN interface name to write to (e.g. `vcan0`, `can0`) |
